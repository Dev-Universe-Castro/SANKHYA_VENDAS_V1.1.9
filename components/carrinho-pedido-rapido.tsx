...
import { ProdutoEditModal } from "@/components/produto-edit-modal"
...
export function CarrinhoPedidoRapido({
  ...
  const handleEditarClick = (item: any, index: number) => {
    setProdutoEditando(item)
    setIndexEditando(index)
    setShowEditModal(true)
  }

  const handleConfirmEdit = (produtoAtualizado: any) => {
    if (indexEditando !== null && produtoAtualizado) {
