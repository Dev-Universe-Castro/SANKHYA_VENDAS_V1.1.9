...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <>
      <header className="border-b border-sidebar-border px-4 lg:px-6 py-4 flex items-center justify-between bg-[oklch(0.32_0.02_235)]">
        ...
        <div className="flex items-center gap-2 lg:gap-3 ml-auto">
          ...
          <Button
            ...
            size="sm"
            variant="outline"
            className="text-white border-white/20 hover:bg-white/10 hidden lg:flex"
          >
            {isLoading ? (
              <>
