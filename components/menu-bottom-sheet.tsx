...
import { Home, Users, Calendar, ShoppingCart, DollarSign, Package, UserCircle, Settings, Download, Loader2, Cloud, CloudOff, LogOut, LayoutGrid, Route } from "lucide-react"
...
export function MenuBottomSheet({ open, onOpenChange }: MenuBottomSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent 
        side="bottom" 
        className="h-[85vh] rounded-t-3xl border-0 p-0 shadow-2xl lg:hidden"
      >
